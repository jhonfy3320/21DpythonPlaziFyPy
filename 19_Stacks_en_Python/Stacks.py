'''
Un stack (o pila) es una estructura de datos lineal que sigue el principio “último en entrar, primero en salir” (Last In, First Out, LIFO). 
Esto significa que el último elemento agregado al stack será el primero en ser eliminado. '''

## En Python, podemos implementar un stack utilizando listas.

## Complejidad Algorítmica

'''
La complejidad de los métodos de un stack en Python depende de la implementación utilizada. Si se utiliza una lista, 
la complejidad es la siguiente:'''
...
# En general, utilizar listas para implementar un stack en Python es una opción eficiente, ya que ofrece un buen 
# rendimiento para todas las operaciones.
...
'''
En esta implementación, hemos creado la clase Node que representa un nodo en el stack, y la clase Stack 
que implementa el stack en sí.
...
'''
El stack es una estructura de datos muy versátil que puede utilizarse en diversas situaciones. 
Algunas oportunidades donde es conveniente utilizar un stack en Python incluyen:

Evaluación de expresiones matemáticas: 
Los stacks son útiles para evaluar expresiones matemáticas en notación postfija (o notación polaca inversa), 
...
Validación de sintaxis: Los stacks pueden ayudar a validar la sintaxis de expresiones, como verificar el equilibrio de paréntesis, 
corchetes y llaves.
Implementación de algoritmos como el recorrido en profundidad (DFS) de un grafo o la búsqueda en profundidad de un árbol.
Es importante tener en cuenta las características del stack y elegir la estructura de datos adecuada según los requisitos 
específicos del problema.

En resumen, hemos aprendido cómo implementar un stack en Python utilizando listas y una clase. 
También hemos explorado las oportunidades en las que un stack puede ser útil y la complejidad algorítmica de los métodos implementados.'''